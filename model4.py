...
class UNETv10_5_2(nn.Module):
    def __init__(
            self, in_channels=3, out_channels=1, features=[64, 128, 256, 512], emb_dim=256
        ):
        super(UNETv10_5_2, self).__init__()
        self.initial_conv = nn.Conv2d(in_channels, features[0], 3, padding=1)
        self.initial_block = ResnetBlock(features[0], features[0], emb_dim)
